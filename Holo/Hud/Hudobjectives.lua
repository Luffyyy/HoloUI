...
function HUDBGBox_create( panel, params, config )
	...
	local right_top = box_panel:bitmap( { halign="right", valign="top", color = FrameColor, rotation = 90, name = "right_top", blend_mode = blend_mode, visible = Holo.options.Frame_enable, layer = 1, texture = "guis/textures/pd2/hud_corner", x = 0, y = 0 } )
	right_top:set_right( box_panel:w())
	
	local right_bottom = box_panel:bitmap( { halign="right", valign="bottom", color = FrameColor, rotation = 180, name = "right_bottom", blend_mode = blend_mode, visible = Holo.options.Frame_enable, layer = 1, texture = "guis/textures/pd2/hud_corner", x = 0, y = 0 } )
...
function HUDObjectives:init( hud )
	...
	local icon_objectivebox = objectives_panel:bitmap( { halign="left", valign="top", name = "icon_objectivebox", blend_mode = "alpha", visible = false, color = Color.white, texture = "guis/textures/pd2/hud_icon_objective",layer = 0, x = 0, y = 0, w = 24, h = 24 } )
