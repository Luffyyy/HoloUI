...
function HUDPlayerDowned:on_downed( ... )
	...
	if Holo.options.HealthNum_style == 1 and Holo.options.HealthNum and (not Holo.options.PDTHHud_support or not (pdth_hud and pdth_hud.loaded_options and pdth_hud.loaded_options.Ingame.MainHud)) and not Holo.options.GageHud_support then 
